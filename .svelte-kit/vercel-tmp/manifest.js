	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../output/server/entries/endpoints/api/get-features/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../output/server/entries/endpoints/api/get-music-links/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../output/server/entries/endpoints/api/get-other-people/_server.js')
			},
			{
				id: "/api/get-other",
				...
				params: [],
				page: null,
				endpoint: () => import('../output/server/entries/endpoints/api/get-other/_server.js')
			},
			{
				id: "/api/get-shows",
				...
				params: [],
				page: null,
				endpoint: () => import('../output/server/entries/endpoints/api/get-shows/_server.js')
			}
		],
		matchers: async () => {
